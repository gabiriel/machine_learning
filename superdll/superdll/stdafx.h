...
*/
	...
	__declspec(dllexport) double perceptron_lineaire_classification(double*, double*, int);
	...
	__declspec(dllexport) double perceptron_lineaire_regression(double*, double*, int);
/*
}
*/